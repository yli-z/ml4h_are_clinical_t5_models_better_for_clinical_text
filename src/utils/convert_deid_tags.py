...
https://github.com/elehman16/do-we-still-need-clinical-lms/blob/main/preprocessing/convert_deid_to_tag.py
"""
...
def convert_deid_to_tag(t: str):
    ...
    if len(t.split('-')) == 3:
        ...
        return ''
    elif 'Ethnicity' in t: # Ethnicity doesn't have tag in original Clinical-T5 code 
        return t
    else:       
        raise NotImplementedError(f"tag {t} Not available.")
